...
\begin{tikzpicture}[scale=0.8]
  ...
  \addplot[adaPurple, bar width=14pt, fill=adaPurple] coordinates {\VAR{attendance_zip}};
  \addplot[adaYellow, bar width=14pt, fill=adaYellow] coordinates {\VAR{punctuality_zip}};
